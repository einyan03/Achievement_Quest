...
bool Entity::collideBox(Entity &ent, VECTOR2 &collisionVector)
{
	...
	if (collisionType == entityNS::BOX && ent.getCollisionType() == entityNS::BOX)
	{
		// Check for collision using Axis Aligned Bounding Box - CENTER PART
...
// hit with tile (where the colliding box is its bottom)
bool Entity::collideBoxBottom(Entity &ent, VECTOR2 &collisionVector)
{
	// if either entity is not active then no collision may occcur
	if (!active || !ent.getActive())
		return false;
	...
	if (collisionType == entityNS::BOX && ent.getCollisionType() == entityNS::BOX)
	{
		...
		if ((getCenterX() + edge.right*getScale() >= ent.getCenterX() + ent.getEdge().left*ent.getScale()) &&
			(getCenterX() + edge.left*getScale() <= ent.getCenterX() + ent.getEdge().right*ent.getScale()) &&
			(getCenterY() + edge.bottom*getScale() >= ent.getCenterBY() + ent.getEdge().top*ent.getScale()) &&
			(getCenterY() + edge.top*getScale() <= ent.getCenterBY() + ent.getEdge().bottom*ent.getScale()))
		{
			// set collision vector
			collisionVector = *ent.getCenterBottom() - *getCenter();
			return true;
		}
		return false;
	}
...
// hit with tile (where the colliding box is its top)
bool Entity::collideBoxTop(Entity &ent, VECTOR2 &collisionVector)
{
	// if either entity is not active then no collision may occcur
	if (!active || !ent.getActive())
		return false;
	...
	if (collisionType == entityNS::BOX && ent.getCollisionType() == entityNS::BOX)
	{
		...
		if ((getCenterX() + edge.right*getScale() >= ent.getCenterX() + ent.getEdge().left*ent.getScale()) &&
			(getCenterX() + edge.left*getScale() <= ent.getCenterX() + ent.getEdge().right*ent.getScale()) &&
			(getCenterY() + edge.bottom*getScale() >= ent.getCenterTY() + ent.getEdge().top*ent.getScale()) &&
			(getCenterY() + edge.top*getScale() <= ent.getCenterTY() + ent.getEdge().bottom*ent.getScale()))
		{
			// set collision vector
			collisionVector = *ent.getCenterTop() - *getCenter();
			return true;
		}
		return false;
	}
...
// hit with tile (where the colliding box is its right)
bool Entity::collideBoxRight(Entity &ent, VECTOR2 &collisionVector)
{
	// if either entity is not active then no collision may occcur
	if (!active || !ent.getActive())
		return false;
	...
	{
		// Check for collision using Axis Aligned Bounding Box 
		if ((getCenterX() + edge.right*getScale() >= ent.getCenterRX() + ent.getEdge().left*ent.getScale()) &&
			(getCenterX() + edge.left*getScale() <= ent.getCenterRX() + ent.getEdge().right*ent.getScale()) &&
			(getCenterY() + edge.bottom*getScale() >= ent.getCenterY() + ent.getEdge().top*ent.getScale()) &&
			(getCenterY() + edge.top*getScale() <= ent.getCenterY() + ent.getEdge().bottom*ent.getScale()))
		{
			// set collision vector
			collisionVector = *ent.getCenterRight() - *getCenter();
			return true;
		}
		return false;
	}
...
// hit with tile (where the colliding box is its left)
bool Entity::collideBoxLeft(Entity &ent, VECTOR2 &collisionVector)
{
	// if either entity is not active then no collision may occcur
	if (!active || !ent.getActive())
		return false;
	...
	{
		// Check for collision using Axis Aligned Bounding Box 
		if ((getCenterX() + edge.right*getScale() >= ent.getCenterLX() + ent.getEdge().left*ent.getScale()) &&
			(getCenterX() + edge.left*getScale() <= ent.getCenterLX() + ent.getEdge().right*ent.getScale()) &&
			(getCenterY() + edge.bottom*getScale() >= ent.getCenterY() + ent.getEdge().top*ent.getScale()) &&
			(getCenterY() + edge.top*getScale() <= ent.getCenterY() + ent.getEdge().bottom*ent.getScale()))
		{
			// set collision vector
			collisionVector = *ent.getCenterLeft() - *getCenter();
			return true;
		}
		return false;
	}
