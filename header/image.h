...
public:
	...
	// return center x - left box
	virtual float getCenterLX()		{ return spriteData.x + spriteData.width / 5 * getScale(); }

	// return center x - right box
	virtual float getCenterRX()		{ return spriteData.x + spriteData.width / 5 * 4 * getScale(); }

	// return center y - bottom box
	virtual float getCenterBY()		{ return spriteData.y + spriteData.height / 5 * 4 * getScale(); }

	// return center y - top box
	virtual float getCenterTY()		{ return spriteData.y + spriteData.height / 5 * getScale(); }
