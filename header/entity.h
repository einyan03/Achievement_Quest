...
public:
	...
	// left box - center
	virtual const VECTOR2* getCenterLeft()
	{
		center = VECTOR2(getCenterLX(), getCenterY());
		return &center;
	}

	// right box - center 
	virtual const VECTOR2* getCenterRight()
	{
		center = VECTOR2(getCenterRX(), getCenterY());
		return &center;
	}

	// top box - center
	virtual const VECTOR2* getCenterTop()
	{
		center = VECTOR2(getCenterX(), getCenterTY());
		return &center;
	}

	// bottom box - center
	virtual const VECTOR2* getCenterBottom()
	{
		center = VECTOR2(getCenterX(), getCenterBY());
		return &center;
	}
	...
	virtual bool collideBoxLeft(Entity &ent, VECTOR2 &collisionVector);

	virtual bool collideBoxRight(Entity &ent, VECTOR2 &collisionVector);

	virtual bool collideBoxBottom(Entity &ent, VECTOR2 &collisionVector);

	virtual bool collideBoxTop(Entity &ent, VECTOR2 &collisionVector);
